...
class Moire_dataset_test(Dataset):
    def __init__(self, root, loader = default_loader):
        ...
        moire_rgb_root = os.path.join(root, 'moire_RGB')

        image_names = os.listdir(moire_rgb_root)
        ...
        self.moire_rgb_images = [os.path.join(moire_rgb_root, x + '_m.png') for x in image_names]
    ...
    def __getitem__(self, index):
        ...
        moire_rgb_path = self.moire_rgb_images[index]
        ...
        moire_rgb_img = self.loader(moire_rgb_path, 'rgb')
        ...
        moire_rgb_img = torch.from_numpy(moire_rgb_img)
        ...
        moire_rgb_img = moire_rgb_img.type(torch.FloatTensor).permute(2,0,1).cuda() 
        num_img = self.labels[index]
        
        return moire_raw_img,gt_raw_img, class_img,moire_rgb_img, gt_rgb_img, num_img#, label
